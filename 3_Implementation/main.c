...
void ticket1(int choice,char name[10],int id2,int price)
{
		system("cls");
		printf("\n\n");
        printf("\t_______________THEATER BOOKING TICKET______________________\n");
        printf("\t***********************************************************\n");
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 RRR\n\n");
	printf("\t\t\tpress 2 THE KASHMIR FILE\n\n");
	printf("\t\t\tpress 3 BATMAN\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
		system("cls");
		printf("\n\n");
        printf("\t________________THEATER BOOKING TICKET______________________\n");
        printf("\t************************************************************\n");
        printf("\t Booking ID : %d \t\t\tShow Name : THE KASHMIR FILE\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 11-03-2022\n");
        printf("\t                                              Time      : 09:00pm\n");
        printf("\t                                              Hall      : 03\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
int cmovie(void)
{
	...
	printf("\t\t\t-------------------------------------\n");
	printf("\t\t\tpress 1 RRR\n\n");
	printf("\t\t\tpress 2 THE KASHMIR FILES\n\n");
	printf("\t\t\tpress 3 BATMAN\n");
	scanf("%d",&i);
	return i;		
}
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t***********************************************************\n");
        printf("\t Booking ID : %d \t\t\tShow Name : BATMAN \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 22-03-2022\n");
        printf("\t                                              Time      : 10:00pm\n");
        printf("\t                                              Hall      : 04\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
